...
def mock_settings_service():
    ...
    service.logger.logger.warning = MagicMock()
    service.logger.logger.debug = MagicMock()
    return service
...
class TestSettingsApiErrorLogging:
    ...
    @pytest.mark.asyncio
    async def test_get_all_settings_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_get_settings_categories_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_get_setting_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_update_setting_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_reset_setting_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_reset_all_settings_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_export_settings_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_import_settings_logs_error(self, mock_settings_service):
    ...
    @pytest.mark.asyncio
    async def test_validate_path_logs_error(self, mock_settings_service):
        ...
        # Patch pathlib.Path at the source so the local import inside the function picks it up
